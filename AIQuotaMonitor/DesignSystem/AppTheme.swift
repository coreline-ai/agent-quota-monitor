...
enum AppTheme {
    static let accentColor = Color(red: 0.23, green: 0.37, blue: 0.88)
    static let cyan = Color(red: 0.14, green: 0.69, blue: 0.79)
    static let warning = Color(red: 0.94, green: 0.58, blue: 0.14)
